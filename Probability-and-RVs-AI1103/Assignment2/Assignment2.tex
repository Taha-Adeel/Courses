...
\begin{align}
    \sigma %&= \sum_{X \in \mathbb{R}} \left(  (E\left[ X-E[X] \right])^2 \pr{X} \label{varience} \right)\\
    = E[X^2] - E[X]^2
\end{align}
...
\end{enumerate}
\par \vspace{0.3cm}
$\therefore  E[X]$ and $E[X^2]$ cannot attain the values $2$ and $3$ respectively. (\textbf{Option B}) (As then the variance would be negative (Refer \eqref{negative_variance})
\end{document}
