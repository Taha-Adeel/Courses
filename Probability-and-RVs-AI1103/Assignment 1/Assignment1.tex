...
Our sample space S consists of 2 minutes time after the person starts playing.
\begin{align}
    S = 2 \text{ minutes}
\end{align}
The event size E is the first half-minute after starting
\begin{align}
    E = 0.5 \text{ minutes}
\end{align}
\\The probability that the music will stop within the first half-minute after starting is
\begin{align}
    \pr{E} = \dfrac{E}{S} = \dfrac{0.5}{2} = 0.25
\end{align}
...
\begin{figure}[h]
  ...
  \end{figure}
  \par \vspace{0.3cm} The python code is available in 
  \begin{lstlisting}
  https://github.com/Taha-Adeel/AI1103/tree/main/Assignment%201/codes
  \end{lstlisting}
